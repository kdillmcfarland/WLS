###########################################################################################
#simper.pretty: automates running of simper for comparisons of interest
#Andrew Steinberger, Madison Cox, Kim Dill-Mcfarland - UW-Madison
#
#Simper (OTU correlations within inver-metric correlations)
#Function makes list with the names of all the columns from metrics file that you want to
#analyze with SIMPER and combines all results into csv file
#
#x=OTU.table  metrics=metadata.table  interesting=list the colum headers of interest from 
#   metrics file ex. c('sloth_sp','type','sp.type')
...
#low_val=value of low cutoff (0.01)   output_name=name to append to the simper and 
#   clean_simper output files
###########################################################################################
